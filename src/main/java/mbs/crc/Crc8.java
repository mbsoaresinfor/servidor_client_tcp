...
public class Crc8 {
    ...
    // codidgo retirado da pagina:
    // https://stackoverflow.com/questions/25284556/translate-crc8-from-c-to-java
    public static void calc(Protocol protocol) {

    	int crc_U = CRC_PRESET;
        byte[] frame_U =  protocol.getData().getBytes();
